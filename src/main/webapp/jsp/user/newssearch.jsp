		...
		<div class="container">
			<div class="navbar-header">
				<div class="navbar-brand">
					<img src="${pageContext.request.contextPath}/static/plugings/image/timg%20.jpg" alt="mkm" height="36" width="200">
				</div>
		  	</div>
					...
					<li style="left: 150px;margin-top: 5px">
						<div class="search-bar" >
                            <form action="" >
                                ...
                                <input type="button" onclick="finds()" value="搜索">
                            </form>
                            <%--<a href="${pageContext.request.contextPath}/news/mohufind">发参</a>--%>
						</div>
					</li>
			...
			<div class="col-md-7">
				...
				<div class="pagination" >
					...
					<div class="news-list-item clearfix">
						<div class="col-xs-5">
							<c:if test="${obj.imgurl==null}">11<img src="/upload/2019/6/2019061201295256.jpg" class="img-responsive" /></c:if>
                    ...
                    <div>
                            ...
                            <a href="${pageContext.request.contextPath}/news/mohufind/${name}?PageNum=1">首页 </a>

                            <c:choose>

                            <c:when test="${pageInfo.hasPreviousPage }">

                            <a href="${pageContext.request.contextPath}/news/mohufind/${name}?PageNum=${pageInfo.pageNum-1}">上一页 </a>
                            ...
                            <a href="${pageContext.request.contextPath}/news/mohufind/${name}?PageNum=${item}">${item}</a>
                            ...
                            <a href="${pageContext.request.contextPath}/news/mohufind/${name}?PageNum=${pageInfo.pageNum+1}">下一页 </a>

                            <a href="${pageContext.request.contextPath}/news/mohufind/${name}?PageNum=${pageInfo.pages}">尾页</a>
