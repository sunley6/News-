    ...
    <div style="padding: 15px;">
        ...
        <table class="layui-table" lay-data="{page:true, id:'idTest'}" lay-filter="demo" >
            ...
            <tr>
                ...
                <%--<th width="15%">性别</th>--%>
                <%--<th width="25%">操作</th>--%>
                    <th lay-data="{field:'id', width:80, sort: true, fixed: true}">类别ID</th>
                    <th lay-data="{field:'Uname', width:150}">类别名称</th>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.confirm('真的删除行么', function(index){
                    ...
                    $.ajax({
                        data : {'Cid':data.id},
                        url : "${pageContext.request.contextPath }/news/delType",
                        type : "post",
                ...
                $.ajax({
                    url : "${pageContext.request.contextPath }/news/editTypeInfo",
                    type : "post",
                    data : {'Cid':data.id},
                    success : function (data) {

                            location.href="${pageContext.request.contextPath}/jsp/editType.jsp";
