    ...
    <div style="padding: 15px;">
        ...
        <table class="layui-table" lay-data="{page:true, id:'idTest'}" lay-filter="demo" >
            ...
            <tr>
                ...
                <%--<th width="15%">性别</th>--%>
                <%--<th width="25%">操作</th>--%>
                    <th lay-data="{field:'id', width:80, sort: true, fixed: true}">新闻ID</th>
                    <th lay-data="{field:'newsTitle', width:150}">新闻标题</th>
                    <th lay-data="{field:'newsText', width:150, }">新闻关键字</th>
                    <th lay-data="{field:'newsContent', width:200}">新闻内容</th>
                    <th lay-data="{field:'newsCreatetime',width:150}">创建时间</th>
                    <th lay-data="{field:'newsType',width:100}">新闻类型</th>
           ...
           <c:forEach items="${newsList}" var="obj">
               <tr>
                   ...
                   <td>${obj.newsTitle}</td>
                   <td>${obj.newsText}</td>
                   <td>${obj.newsContent}</td>
                   <td>${obj.newsCreatetime}</td>
                   <td>${obj.newsType}</td>
        ...
        <script type="text/html" id="barDemo">
            <a  class="layui-btn layui-btn-sm" lay-event="edit" id="edit">编辑</a>
        ...
        table.on('tool(demo)', function(obj){
            ...
            if(obj.event === 'del'){
                ...
                layer.confirm('真的删除行么', function(index){
                    ...
                    $.ajax({
                        data : {'newsId':data.id},
                        url : "${pageContext.request.contextPath }/news/delnews",
                        type : "post",
