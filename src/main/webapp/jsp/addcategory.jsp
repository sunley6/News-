...
<div class="layui-body">
    ...
    <div style="padding: 15px;">
        ...
        <form class="layui-form" action="${pageContext.request.contextPath}/news/addType">

            <div class="layui-form-item">
                <label class="layui-form-label">类别名称</label>
                <div class="layui-input-inline">
                    <input type="text" name="categoryName" required lay-verify="required" placeholder="请输入类别" autocomplete="off" class="layui-input">
                </div>
